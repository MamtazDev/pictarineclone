...
function Home() {
  return (
    <>
      ...
      <div className="style_background_width">
          ...
          <div className="g-pictarinesvision">
            ...
            <div className="text-pictarinesvision">
              ...
              <p>
                ...
                C&apos;est parti, on lace nos baskets ! On trouve ça important
                de sensibiliser au dépistage du Cancer du Sein ? Tout le monde
                se mobilise, et pour un habit rose porté on reverse 5 euros de
                don à la Ligue contre le Cancer du Sein. Besoin de parrains pour
                le French Tech Tremplin ? On est ravis d&apos;aider des jeunes
                issus de quartiers difficiles, boursiers ou en situation de
                handicap, à accéder à l&apos;entreprenariat.
              </p>
            </div>
          </div>
